...
class TrainingService:
    ...
    def train_ticker_candidate(
        ...
        metadata = {
            ...
            "feature_set_version": "feature_pipeline_v1_core_subset_vol_scaled_labels" + ("_with_context_v0_3_4" if use_context_features else ""),
            "label_mode": "volatility_scaled_multi_head_candidate_v2",
            "training_method": "context_aware_recency_weighted_candidate_training_v0_3_4" if use_context_features else "recency_weighted_candidate_training_v0_3_3",
