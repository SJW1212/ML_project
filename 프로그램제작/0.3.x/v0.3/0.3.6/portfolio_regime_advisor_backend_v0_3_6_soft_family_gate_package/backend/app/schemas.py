...
class TrainingRequest(BaseModel):
    ...
    # v0.3.4 context-feature controls. Off by default to keep v8.6.41/prediction_file
    # and v0.3.3 candidate behavior reproducible.
    ...
    def normalize_context_provider(cls, value: str) -> str:
        return value.lower().strip()
