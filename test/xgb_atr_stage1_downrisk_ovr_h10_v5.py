"""
XGBoost ATR-aware Risk-first Model v5-H10 - Stage1 + Down-risk OVR
======================================================
...
실행
    py xgb_atr_stage1_downrisk_ovr_h10_v5.py
...
class Config:
    ...
    result_dir: str = "results_xgb_atr_stage1_downrisk_ovr_h10_v5"
            ...
            for high_w in high_weight_list:
                for down_w in down_weight_list:
                    for ntb in no_trade_list:
                        grid.append({
                            "name": f"xgb_h10_v5_downrisk_cfg_{idx:04d}",
...
def default_alloc_config(cfg: Config) -> Dict[str, float]:
    return {
        "name": "default_xgb_atr_stage1_downrisk_ovr_h10_v5",
...
def build_summary(pred_df: pd.DataFrame, feature_cols: List[str], cfg_usage: Dict[str, int], cfg: Config) -> Dict[str, object]:
    ...
    summary = {
        ...
        "model_type": "xgb_atr_stage1_downrisk_ovr_risk_first_h10_v5",
        "config": asdict(cfg),
        "period": {
...
def print_summary(summary: Dict[str, object]) -> None:
    ...
    print("\n==============================")
    print("XGBoost ATR-aware H10 v5 결과 요약")
    print("Stage1 + Down-risk OVR + Final Cascade")
    print("==============================")
...
def main() -> None:
    ...
    pred_path = result_dir / "qqq_xgb_atr_stage1_downrisk_ovr_h10_v5_predictions.csv"
    summary_path = result_dir / "qqq_xgb_atr_stage1_downrisk_ovr_h10_v5_summary.json"
    latest_path = result_dir / "qqq_xgb_atr_stage1_downrisk_ovr_h10_v5_latest.json"
