...
실행 예시
    py xgb_recency_weighted_v8_6_42_adaptive_recency_profile.py --speed-profile balanced --h10-down-only
    py xgb_recency_weighted_v8_6_42_adaptive_recency_profile.py --speed-profile fast --h10-down-only
    py xgb_recency_weighted_v8_6_42_adaptive_recency_profile.py --speed-profile full --adaptive-label --h10-down-only
...
# ============================================================
# v8.6.42 asset-class recency profile
# ============================================================
BROAD_INDEX_TICKERS = {"QQQ", "SPY", "DIA", "IWM", "VTI", "VOO", "IVV", "SCHB", "SPLG"}
MEGA_CAP_TICKERS = {"AAPL", "MSFT", "GOOGL", "GOOG", "AMZN", "META", "AVGO", "LLY", "COST", "NFLX"}
SECTOR_ETF_TICKERS = {"SOXX", "SMH", "XLK", "XLY", "XLF", "XLV", "XLE", "XLI", "XLC", "ARKK"}
HIGH_VOL_GROWTH_TICKERS = {"NVDA", "TSLA", "AMD", "PLTR", "MSTR", "COIN", "SMCI"}


def infer_asset_class_v8642(ticker: str) -> str:
    t = str(ticker).upper().strip()
    if t in BROAD_INDEX_TICKERS:
        return "broad_index"
    if t in SECTOR_ETF_TICKERS:
        return "sector_etf"
    if t in HIGH_VOL_GROWTH_TICKERS:
...
def apply_asset_class_recency_profile_v8642(cfg: "Config") -> "Config":
    """Remove one-size-fits-all recency half-life.

    This changes sample-weight half-life before walk-forward training. It is not selected by final CAGR;
    it is a conservative asset-class prior.
    """
    ac = infer_asset_class_v8642(cfg.target_ticker)
    cfg.asset_class_recency_profile = ac  # diagnostic attribute
    if ac == "broad_index":
        cfg.recency_half_life_5d = 126
        cfg.recency_half_life_10d = 252
        cfg.recency_half_life_20d = 504
    elif ac == "mega_cap":
        cfg.recency_half_life_5d = 126
        cfg.recency_half_life_10d = 252
        cfg.recency_half_life_20d = 378
    elif ac == "sector_etf":
        cfg.recency_half_life_5d = 84
        cfg.recency_half_life_10d = 168
        cfg.recency_half_life_20d = 378
    elif ac == "high_vol_growth":
        cfg.recency_half_life_5d = 63
        cfg.recency_half_life_10d = 126
        cfg.recency_half_life_20d = 252
    else:
        cfg.recency_half_life_5d = 126
        cfg.recency_half_life_10d = 252
        cfg.recency_half_life_20d = 378
...
class Config:
    ...
    result_dir: str = "results_xgb_recency_weighted_v8_6_42_adaptive_recency_profile"
...
def build_summary(pred_df: pd.DataFrame, feature_cols: List[str], gate_usage: Dict[str, int], cfg: Config) -> Dict[str, object]:
    ...
    return {
        "model_type": "xgb_recency_weighted_v8_6_42_adaptive_recency_profile_diagnostics",
...
def apply_speed_profile(cfg: Config, profile: str) -> Config:
    if profile == "fast":
        ...
        cfg.result_dir = "results_xgb_recency_weighted_v8_6_42_adaptive_recency_profile_fast"
        ...
        cfg.use_adaptive_label_policy = False
        cfg.use_rolling_gate_optimization = False
        cfg.result_dir = "results_xgb_recency_weighted_v8_6_42_adaptive_recency_profile_balanced"
    elif profile == "full":
        cfg.retrain_every_n_days = 10
        ...
        cfg.use_rolling_gate_optimization = False
        cfg.result_dir = "results_xgb_recency_weighted_v8_6_42_adaptive_recency_profile_full_adaptive_label"
    else:
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--disable-asset-class-recency-profile", action="store_true", help="v8.6.42 asset-class별 recency half-life profile 비활성화")
    ...
    # v8.6.42 adaptive recency profilees
...
def main() -> None:
    ...
    if getattr(args, "asset_list", None) or getattr(args, "asset_preset", None):
        ...
        batch_root = Path(args.result_dir or "results_xgb_recency_weighted_v8_6_42_adaptive_recency_profile_multi_asset")
        ...
        for ticker in tickers:
            ...
            summary_path = out_dir / f"{safe}_xgb_recency_weighted_v8_6_42_adaptive_recency_profile_summary.json"
    ...
    if not getattr(args, "disable_asset_class_recency_profile", False):
        cfg = apply_asset_class_recency_profile_v8642(cfg)

    # v8.6.42 adaptive recency profile CLI overrides
    ...
    cfg.result_dir = f"results_xgb_recency_weighted_v8_6_42_adaptive_recency_profile_{cfg.policy_mode}"
    ...
    file_prefix = f"{safe_ticker}_xgb_recency_weighted_v8_6_42_adaptive_recency_profile"
