...
def build_summary(pred_df: pd.DataFrame, feature_cols: List[str], gate_usage: Dict[str, int], cfg: Config) -> Dict[str, object]:
    ...
    return {
        "model_type": "xgb_multi_horizon_stage1_gated_downrisk_v8_4_diagnostics",
...
def print_summary(summary: Dict[str, object]) -> None:
    ...
    print("\n==============================")
    print("XGBoost v8.4 Diagnostics 결과 요약")
...
def main() -> None:
    ...
    pred_path = result_dir / "qqq_xgb_v8_4_predictions.csv"
    summary_path = result_dir / "qqq_xgb_v8_4_summary.json"
    latest_path = result_dir / "qqq_xgb_v8_4_latest.json"
    importance_stage1_path = result_dir / "qqq_xgb_v8_4_stage1_feature_importance.csv"
    importance_down_path = result_dir / "qqq_xgb_v8_4_downrisk_feature_importance.csv"
    condition_search_path = result_dir / "qqq_xgb_v8_4_condition_search.csv"
    ...
    for name, diag_df in diagnostics.items():
        if diag_df is not None and not diag_df.empty:
            pth = result_dir / f"qqq_xgb_v8_4_{name}.csv"
