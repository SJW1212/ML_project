"""
XGBoost v8.6.5 - Pruned Feature Directional Risk Allocation
====================================================================
...
class Config:
    ...
    result_dir: str = "results_xgb_v8_6_5_pruned_features"
...
def build_summary(pred_df: pd.DataFrame, feature_cols: List[str], gate_usage: Dict[str, int], cfg: Config) -> Dict[str, object]:
    ...
    return {
        "model_type": "xgb_multi_branch_pruned_features_v8_6_5_diagnostics",
...
def apply_speed_profile(cfg: Config, profile: str) -> Config:
    if profile == "fast":
        ...
        cfg.result_dir = "results_xgb_v8_6_5_pruned_fast"
        ...
        cfg.use_adaptive_label_policy = False
        cfg.use_rolling_gate_optimization = False
        cfg.result_dir = "results_xgb_v8_6_5_pruned_balanced"
    elif profile == "full":
        cfg.retrain_every_n_days = 10
        ...
        cfg.use_rolling_gate_optimization = False
        cfg.result_dir = "results_xgb_v8_6_5_pruned_full_adaptive_label"
    else:
...
def main() -> None:
    ...
    print("[3/5] Walk-forward H10/H20 Stage1 + Up/Down 방향성 예측(Pruned features)")
    ...
    pred_path = result_dir / "qqq_xgb_v8_6_5_pruned_predictions.csv"
    summary_path = result_dir / "qqq_xgb_v8_6_5_pruned_summary.json"
    latest_path = result_dir / "qqq_xgb_v8_6_5_pruned_latest.json"
    importance_stage1_path = result_dir / "qqq_xgb_v8_6_5_pruned_stage1_feature_importance.csv"
    importance_up_path = result_dir / "qqq_xgb_v8_6_5_pruned_up_feature_importance.csv"
    importance_down_path = result_dir / "qqq_xgb_v8_6_5_pruned_downrisk_feature_importance.csv"
    importance_down_price_trend_path = result_dir / "qqq_xgb_v8_6_5_pruned_downrisk_price_trend_feature_importance.csv"
    importance_down_price_volume_path = result_dir / "qqq_xgb_v8_6_5_pruned_downrisk_price_volume_feature_importance.csv"
    importance_down_volatility_path = result_dir / "qqq_xgb_v8_6_5_pruned_downrisk_volatility_feature_importance.csv"
    condition_search_path = result_dir / "qqq_xgb_v8_6_5_pruned_condition_search.csv"
    ...
    for name, diag_df in diagnostics.items():
        if diag_df is not None and not diag_df.empty:
            pth = result_dir / f"qqq_xgb_v8_6_5_pruned_{name}.csv"
